...
from solution import count_fully_overlap_ranges, count_overlap_ranges
...
class MyTestCase(unittest.TestCase):
    ...
    def test_score_small_input_part_2(self):
        ...
        actual = count_overlap_ranges('test/input-small.txt')
        self.assertEqual(expected, actual)

    def test_score_large_input_part_2(self):
        expected = read_int('test/output-large-part2.txt')
        actual = count_overlap_ranges('test/input-large.txt')
        self.assertEqual(expected, actual)
